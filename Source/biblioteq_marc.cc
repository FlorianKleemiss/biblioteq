				...
				if (tag == "010")
				{
					...
					*/
					...
					while (reader.readNextStartElement())
						...
						{
							if (reader.attributes().value("code").toString().toLower().trimmed() == "a")
							{
				...
				else if (tag == "050")
				{
					...
					*/
					...
					while (reader.readNextStartElement())
						...
						{
							if (reader.attributes().value("code").toString().toLower().trimmed() == "a" ||
								reader.attributes().value("code").toString().toLower().trimmed() == "b")
								str.append(reader.readElementText());
							else
								reader.skipCurrentElement();
						}
					...
					*/
					...
					while (reader.readNextStartElement())
						if (reader.name().toString().toLower().trimmed() == "subfield")
						{
							if (reader.attributes().value("code").toString().toLower().trimmed() == "a" ||
								reader.attributes().value("code").toString().toLower().trimmed() == "b" ||
								reader.attributes().value("code").toString().toLower().trimmed() == "m" ||
								reader.attributes().value("code").toString().toLower().trimmed() == "q")
								str.append(reader.readElementText());
							else
								reader.skipCurrentElement();
						}
					...
					*/
					...
					while (reader.readNextStartElement())
						if (reader.name().toString().toLower().trimmed() == "subfield")
						{
							...
							else if (reader.attributes().value("code").toString().toLower().trimmed() == "b")
								publisher = reader.readElementText();
							else if (reader.attributes().value("code").toString().toLower().trimmed() == "c")
							{
					...
					m_publicationDate = QDate::fromString("01/01/" + date.mid(0, 4), "MM/dd/yyyy");

					if (publisher.endsWith(","))
						publisher = publisher.mid(0, publisher.length() - 1).trimmed();
	...
	for (int i = 0; i < list.size(); i++)
	{
		...
		else if (str.startsWith("082 "))
		{
			...
			*/
			...
			str = str.remove(" $b").remove(" $m").remove(" $q").trimmed();
		...
		else if (str.startsWith("250 "))
		{
			...
			*/
			...
			str = str.remove("d").remove("h").remove("n").remove("r").remove("s").remove("t").trimmed();
			m_edition = str;
		}
			...
			*/
			...
			for (int j = 0; j < tmplist.size(); j++)
			{
				...
				if (tmpstr.lastIndexOf(" ") > -1)
					tmpstr = tmpstr.mid(0, tmpstr.lastIndexOf(" ")).trimmed();
			...
			if (str.indexOf("$c") > -1 &&
				str.mid(str.indexOf("$c") + 2, 4).toLower().contains("c"))
				m_publicationDate = QDate::fromString("01/01/" +
	...
	for (int i = 0; i < list.size(); i++)
	{
		...
		else if (str.startsWith("205 "))
		{
			...
			*/
			...
			str = str.remove(".").remove("d").remove("h").remove("n").remove("r").remove("s").remove("t").trimmed();
			m_edition = str;
		}
		else if (str.startsWith("210 "))
		{
			...
			*/
			...
			if (str.indexOf("$d") > -1 &&
				str.mid(str.indexOf("$d") + 2, 4).toLower().contains("c"))
				m_publicationDate = QDate::fromString("01/01/" +
